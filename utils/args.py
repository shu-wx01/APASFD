...
def get_args():
    ...
    parser = argparse.ArgumentParser('APASFD')
    parser.add_argument('-d', '--data', type=str, choices=["wikipedia", "gambling"], help='Dataset name',
                        default='wikipedia')
    parser.add_argument('--tasks', type=str, default="NC", choices=["NC"], help='task name')
    parser.add_argument('--bs', type=int, default=200, help='Batch_size')
    parser.add_argument('--prefix', type=str, default='APASFD', help='Prefix to name the checkpoints')
    ...
    parser.add_argument('--pretrain', action='store_true',
                        help='use linkpred task model as pretrain model to learn NC')
